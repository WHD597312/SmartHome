package com.xinrui.smart.view_custom.scene;
...
DragGridView extends GridView {
   ...
   public DragGridView(Context context) {
    ...
    public DragGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWindownManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                //获取DragGridView自动向上滚动的偏移量，小于这个值，DragGridView向下移动
    ...
    private void createDragImage(Bitmap bitmap, int downX, int downY) {
        ...
        mWindownManager.addView(mDragImageView, mWindowLayoutParams);
    }
    ...
    private void removeDragImage() {
        if (mDragImageView != null) {
            mWindownManager.removeView(mDragImageView);
            mDragImageView = null;
        }
    }
    ...
    private void onDragItem(int moveX, int moveY) {
        ...
        mWindownManager.updateViewLayout(mDragImageView, mWindowLayoutParams);//更新镜像的位置
     ...
     * 当moveY的值大于向上滚动的边界值，触发GridView自动向下滚动
     * 否则不进行滚动
     */
